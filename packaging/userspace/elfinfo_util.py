...
from compat_shims import Reversible, Sequence, Tuple, overload
...
class DynamicSectionTable(
	...
	@overload
	def __init__(  # noqa: F811; pylint: disable=E0102
		self,
...
class ElfVersionRefGroup(FrozenList[str]):
	...
	@overload
	def __init__(self, soname: str, entries: Iterable[str]):  # noqa: F811; pylint: disable=E0102
		pass

	def __init__(self, soname: str, *args: Iterable[str]):  # noqa: F811; pylint: disable=E0102
		if len(args) > 1:
			raise ValueError('Too many positional arguments')
