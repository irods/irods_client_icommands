...
from compat_shims import Iterable, Mapping, MutableSequence, Tuple, overload
...
class RunpathUtilOptions(RunpathUtilOptionsBase):
	...
	runpath = RunArgOption(
		metavar='RUNPATH',
		action='store', default=None
	)
	libraries = RunArgOption(
		metavar='FILE', nargs='+',
		action='store', opt_type=str, default=None
	)
...
class RunpathUtil(PackagerUtilBase[RunpathUtilOptionsBase]):
	...
	@overload
	def set_rpath_dispatch(  # noqa: F811; pylint: disable=E0102
		self,
