...
from compat_shims import MutableMapping, NoReturn
...
class PackagerOptionsBase(RunOptsContainer):  # pylint: disable=W0223
	...
	verbosity = RunOption(opt_type=int, default=0)
