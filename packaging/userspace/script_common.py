...
from compat_shims import Callable, Collection, Iterable, Iterator, MutableSequence
from compat_shims import Sequence, overload
...
class FrozenList(Sequence[T_co]):
	...
	@overload
	def __init__(self, iterable: Iterable[T_co]):  # noqa: F811; pylint: disable=E0102
		pass

	def __init__(self, *args: Iterable[T_co]):  # noqa: F811; pylint: disable=E0102
		super().__init__()
		if len(args) > 1:
