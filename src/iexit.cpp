...
main( int argc, char **argv ) {
    ...
    const int ix = myRodsArgs.optind;
...
void usage( char *prog ) {
    std::printf("Exits iRODS session (cwd) and optionally removes\n");
    std::printf("the scrambled password file produced by iinit.\n");
    std::printf("Usage: %s [-fvVh] [full]\n", prog);
    std::printf("If 'full' is included the scrambled password is also removed.\n");
